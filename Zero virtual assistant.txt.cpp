...
using namespace std;// use to give space betwween variable without adding underscore
    ...
    do
    {
        ...
        if(strcmp(password, "0000")==0){
            ...
            do{
                ...
                else if(strcmp(ch, "who are you?") == 0 || strcmp(ch, "tell me about yourself") == 0 || strcmp(ch, "about") == 0 || strcmp(ch, "What about you?") == 0){
                    cout<<"I'm a virtual assistant my name is Zero !!!"<<endl;
                    string phrase = "I am a virtual assistant name is Zero";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
